"""
main_autonomous.py - HYBRID BETTING BOT (WORKING VERSION)
...
ALL_MATCHES = {
    ...
    "atp_1000": [
        {"match": "Djokovic vs Alcaraz", "home": "Djokovic", "away": "Alcaraz", "odds": 2.15, "sport": "tennis"},
    ],
}
...
def main():
    logger.info("=" * 80)
    logger.info("🚀 HYBRID BETTING BOT")
