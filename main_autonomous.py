            ...
            for bk in bookmakers[:1]:
                for market in bk.get("markets", []):
                    ...
                    for outcome in market.get("outcomes", []):
                        ...
                        # Adapt API odds to real BK odds
                        adapted_price = price * 0.7
                        
                        if adapted_price < 1.3 or adapted_price > 5.0:
                            continue
                        
                        # Calculate implied probability
                        implied_prob = 1 / adapted_price if adapted_price > 0 else 0
